...
Languages mirroring parity (no allowlist, intentional spine pass-through):
- Python (`python/src/x402_sdk/interop/server.py`)
- Lua (`lua/bin/interop-server.lua::verify_optional_instructions`)
